...
export default function ResultCard(props: PropsType) {
    ...
    const result = {
        ...
        totalSupply: (Number(props.rawResult.total_supply)/(Math.pow(10, props.rawResult.decimals))).toFixed(2)
    }
    ...
    return(
        <div class="w-full mt-6 py-3 px-4 sm:py-4 sm:px-5 bg-gray-800 rounded-lg">
            ...
            <div class="mt-4 sm:text-lg md:text-xl">
                ...
                <h1 class="text-slate-400 my-1">Total supply: <span class="ml-1 text-gray-50 font-semibold">{Number(result.totalSupply).toLocaleString()}</span> </h1>
            </div>
